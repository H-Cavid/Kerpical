...
export default function Products() {
  ...
  const products = {
    az: [
      { id: 1, name: "Qırmızı kərpic", img: "/brick-hero.jpg" },
      { id: 2, name: "Ağ kərpic", img: "/brick-hero_2.jpg" },
      { id: 3, name: "Boşluqlu kərpic", img: "/brick-hero_3.jpg" },
      { id: 4, name: "Dekorativ kərpic", img: "/brick-hero.jpg" },     // Yenidən 1-ci şəkil
      { id: 5, name: "Odadavamlı kərpic", img: "/brick-hero_2.jpg" },   // Yenidən 2-ci şəkil
      { id: 6, name: "Sement kərpic", img: "/brick-hero_3.jpg" },      // Yenidən 3-cü şəkil
    ],
    en: [
      { id: 1, name: "Red brick", img: "/brick-hero.jpg" },
      { id: 2, name: "White brick", img: "/brick-hero_2.jpg" },
      { id: 3, name: "Hollow brick", img: "/brick-hero_3.jpg" },
      { id: 4, name: "Decorative brick", img: "/brick-hero.jpg" },
      { id: 5, name: "Fire brick", img: "/brick-hero_2.jpg" },
      { id: 6, name: "Cement brick", img: "/brick-hero_3.jpg" },
    ],
    ru: [
      { id: 1, name: "Красный кирпич", img: "/brick-hero.jpg" },
      { id: 2, name: "Белый кирпич", img: "/brick-hero_2.jpg" },
      { id: 3, name: "Пустотелый кирпич", img: "/brick-hero_3.jpg" },
      { id: 4, name: "Декоративный кирпич", img: "/brick-hero.jpg" },
      { id: 5, name: "Огнеупорный кирпич", img: "/brick-hero_2.jpg" },
      { id: 6, name: "Цементный кирпич", img: "/brick-hero_3.jpg" },
    ]
  };
          ...
          {currentProducts.map((product) => (
            ...
            >
              ...
              <div className="relative aspect-[4/3] rounded-3xl overflow-hidden bg-slate-800/50 mb-6 flex items-center justify-center border border-white/5">
                ...
                />
                <div className="absolute top-4 right-4 w-10 h-10 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all translate-y-2 group-hover:translate-y-0 text-white">
